    ...
    useEffect(() => {
        const fetchMovies = async () => {
            try {
                ...
                setPopularMovies([...popularMovies, ...movies.results]);
            } catch(err) {
                console.log(err);
            }
        }
        (async () => await fetchMovies())();
    }, [popularMovies, popCounter])
  ...
  return (
    <Routes>
        <Route path="/" element={<Layout /> }>
            ...
            <Route path="popular">
                <Route index element={<Popular popularMovies={popularMovies} handleLoadMore={handleLoadMore}/>} />
